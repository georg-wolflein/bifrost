...
import { Check, Globe2, KeyRound, Server, WandSparkles } from "lucide-react";
	...
	return (
		<>
			<Button
				...
				className="group relative isolate h-8 overflow-hidden border-0 bg-gradient-to-r from-zinc-950 via-stone-900 to-amber-800 px-3 text-white shadow-lg shadow-amber-900/20 hover:shadow-amber-900/30 dark:from-white dark:via-amber-100 dark:to-amber-300 dark:text-zinc-950"
			>
				<span className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_16%_20%,rgba(251,191,36,0.35),transparent_24%),linear-gradient(110deg,transparent_20%,rgba(255,255,255,0.16)_44%,transparent_64%)]" />
				<WandSparkles className="size-4 transition-transform duration-200 group-hover:rotate-12" />
